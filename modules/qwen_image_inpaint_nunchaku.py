...
from pydantic_models import QwenImageInpaintRequest, ImageResponse
...
def load_qwen_image_pipeline():
    ...
    PIPELINE = QwenImageInpaintPipeline.from_pretrained("Meatfucker/Qwen-Image-bnb-nf4",
...
@avernus_qwen_image.post("/qwen_image_inpaint_nunchaku_generate", response_model=ImageResponse)
def qwen_image_nunchaku_generate(data: QwenImageInpaintRequest = Body(...)):
