...
from pydantic_models import QwenImageEditPlusRequest, QwenImageResponse
...
def load_qwen_image_pipeline():
    ...
    PIPELINE = QwenImageEditPlusPipeline.from_pretrained("Meatfucker/Qwen-Image-Edit-Plus-bnb-nf4",
...
@avernus_qwen_image.post("/qwen_image_edit_plus_nunchaku_generate", response_model=QwenImageResponse)
def qwen_image_edit_plus_nunchaku_generate(data: QwenImageEditPlusRequest = Body(...)):
